...
function email() {
    return names['name:first']().toLowerCase() + (Math.floor(Math.random() * 101) + 1) + '@' + words['word:verb']() + words['word:noun']() + '.com';
}
email.metadata = {
    Label: 'Email',
    Type: 'string'
